...
<body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        <header class="masthead mb-auto">
            <div class="inner">
                ...
                <nav class="nav nav-masthead justify-content-center">
                    ...
                    <a class="nav-link" href="http://192.168.81.50/">Статистика</a>
                    <a class="nav-link active" href="http://192.168.81.50/graphStat.php">График</a><!-- !!! -->
                </nav>
            </div>
        </header>
        ...
        <main role="main" class="inner cover-left">
            ...
            <h2 class="cover-heading">График скорости ответов на запросы</h2>
            <canvas id="myChart" width="600px" height="300px"></canvas>
            <!-- <script src="https://cdn.jsdelivr.net/npm/chart.js"></script> -->
            <script src="./script.js"></script>
            <h5 class="cover-heading">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspШкала Х - время открытия : Шкала Y - вес в
                мб</h5>
            <script>
            </script>
